...
# YOUR CODE HERE
sender = st.text_input("Please write the Sender address")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiver = st.text_input("Please write the Receiver address")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
amount = st.text_input("Please write the amount")
